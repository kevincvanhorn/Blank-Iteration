...
public class GameLoop extends JPanel implements ActionListener {
	...
	public GameLoop(){//CardLayout cards
		...
		try{
			background = ImageIO.read(new File("images/background_rework_level_buffer.png"));
		} catch (IOException e){}
		background =
	...
	public void paint(Graphics g) { //using Graphics object g//try paintComponent (cant be overriden, more specific)
		...
		g2d.drawImage(background.getSubimage(camera.getXcam()+10, camera.getYcam()+10, 600, 500), 0, 0, this);
		//do while on camera
