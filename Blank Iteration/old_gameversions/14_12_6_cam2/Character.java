...
public class Character { //implements Collision{
	...
	public void makePlatList(){
		...
		platList.add(new Rectangle(0, 450, 600, 50));//-100,800
		...
		platList.add(new Rectangle(0, 1150,1000, 50));
	}
	public void updateCollision(int colX, int colY){
		collision.update(colX, colY);
		//System.out.println("update"+colX+" "+colY);
	}
	...
	public String groundRect(){
		return collision.toStringCol(0);
	}
	public void addMs(){
		sprite.addMs30();
	}
