...
public class SpriteSheet{
	...
	public BufferedImage getStaticLeft(int cnt){
		if(cnt == 0)
			return sheet.getSubimage(0, 150, 50, 50);
		else if(cnt == 1)
			return sheet.getSubimage(0, 200, 50, 50);
		else
			return sheet.getSubimage(0, 250, 50, 50);
	}
